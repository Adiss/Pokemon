...
public class App extends Application {
    ...
    public void start(Stage stage){
        ...
        Button btnMove3;
        Button btnMove4;
        if(t1Choosen.getMoves().get(1) != null) btnMove1 = new Button(t1Choosen.getMoves().get(1).getDisplayName()); else btnMove1 = new Button("");
        if(t1Choosen.getMoves().get(2) != null) btnMove2 = new Button(t1Choosen.getMoves().get(2).getDisplayName()); else btnMove2 = new Button("");
        if(t1Choosen.getMoves().get(3) != null) btnMove3 = new Button(t1Choosen.getMoves().get(3).getDisplayName()); else btnMove3 = new Button("");
        if(t1Choosen.getMoves().get(4) != null) btnMove4 = new Button(t1Choosen.getMoves().get(4).getDisplayName()); else btnMove4 = new Button("");
